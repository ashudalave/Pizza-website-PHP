...
<?php
$product['productCode'] = 'strat9';  // works only once per each value
$error_message = null;
...
<br> If so, you can fix it by changing productCode to a new value in the restclient code
