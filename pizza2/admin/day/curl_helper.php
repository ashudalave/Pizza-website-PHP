...
// POST $data in JSON and get back location
// can throw (should have try around the top-level caller)
function post_JSON_return_location($url, $data) {
    $location = null;
    $json_data = json_encode($data);
    curl_request_get_location($url, 'POST', $json_data, 'application/json', $location);
    return $location;
}
